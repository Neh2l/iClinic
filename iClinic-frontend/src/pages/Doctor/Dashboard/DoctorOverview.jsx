  ...
  const appointmentsSeries = useMemo(() => {
    ...
    const series = monthsLabels.map((m, i) =>
      Math.round(
        Math.max(
          2,
          base * (0.5 + (i / monthsLabels.length) * 0.9) +
            (i % 2 === 0 ? base * 0.2 : -base * 0.1)
        )
      )
    );
    return series;
        ...
        <div className="d-flex justify-content-between align-items-center mb-3">
          <div>
            ...
            <small className="text-muted">
              Welcome {doctor.fullName.split(' ')[0]} — overview of your
              practice
            </small>
          </div>
        ...
        <div className="row g-3 mb-3">
          ...
          <div className="col-md-2">
            <div
              ...
              style={{ background: '#0e79a3', color: '#fff', borderRadius: 12 }}
            >
              <img
              ...
              <div className="col-md-3">
                <div className="card p-3 shadow-sm">
                  ...
                  <div className="h5 fw-bold">
                    {doctor.upcomingAppointmentsCount ||
                      Math.max(
                        0,
                        Math.round((doctor.patients?.length || 0) * 0.15)
                      )}
                  </div>
                </div>
              </div>
            ...
            <div className="row g-3 mb-3">
                ...
                <div className="card p-3 shadow-sm text-center">
                  ...
                  <div
                    style={{
                      ...
                      margin: '12px auto',
                      background:
                        'conic-gradient(#0e79a3 0% 32%, #9fc9dc 32% 100%)'
                    }}
                  />
                  <div className="d-flex justify-content-around">
                    <small className="text-muted">
                      <span style={{ color: '#0e79a3' }}>●</span> Sold
                    </small>
                    <small className="text-muted">
                      <span style={{ color: '#9fc9dc' }}>●</span> Total
                    </small>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-5">
                <div className="card p-3 shadow-sm h-100">
                  ...
                  <div className="h4 fw-bold">
                    {(doctor.patients?.length || 0) > 1000
                      ? Math.round(doctor.patients.length / 1000) + 'K'
              ...
              <div className="col-md-3">
                <div className="card p-3 shadow-sm">
                  ...
                  <div className="mt-2">
                    {['Gateway Str', 'Rustic Fox', 'Velvet Vine'].map(
                      (s, i) => (
            ...
            <div className="card shadow-sm p-3">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <div>
                  ...
                  <small className="text-muted">
                    All appointments & patients — full-width detailed view
                  </small>
                </div>
                <div>
                  <button
