  ...
  return (
    <>
      <div
        data-aos="fade-up"
        id="features"
        className="container text-center our-services"
      >
        <div className="services-titles">
          <h1 className="title-one">
            {' '}
            <span className="our-word text"> Our </span>{' '}
            <span className="services-word primary-text"> Services </span>{' '}
          </h1>
            ...
            <div className="card rounded-4 text-start p-4 position-relative">
              ...
              <div className="card-body">
                ...
                <p className="card-text card-paragraph">
                  Get medical advice through secure chat. Ask questions, and
                  receive guidance anytime with our trusted doctors that you
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center">
            <div className="card rounded-4 text-start p-4 position-relative ">
              ...
              <div className="card-body">
                ...
                <p className="card-text card-paragraph">
                  Schedule your doctor visits in just a few clicks. Choose your
                  preferred specialist and time that works best for you.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center">
            <div className="card rounded-4 text-start p-4 position-relative">
              ...
              <div className="card-body">
                ...
                <p className="card-text card-paragraph">
                  Connect with certified doctors immediately via video or voice
                  calls, without the need to wait or travel.
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <>
      <div
        data-aos="fade-up"
        id="how-it-works"
        className="overview-container container"
      >
        <div className="row g-3">
          <div className="overview-info col-lg-4 col-md-5 col-sm-12 ">
            <div className="overview-title">
              <h2 className="text">
                Find The{' '}
                <span className="right-medical-word primary-text">
                  Right <br></br> Medical Specialty{' '}
                </span>{' '}
                <br></br>for you !
              </h2>
            </div>
            <div className="overview-paragraph">
              <p>
                Browse a wide range of medical fields and connect with
                experienced doctors in each specialty. From cardiology and
                dermatology to pediatrics and dentistry, And to be sure you’re
                in safe hands, check some of our patients’ reviews below !
              </p>
            </div>
          </div>
          ...
          <div className="overview-fields col-lg-8 col-md-7 col-sm-12">
            ...
            <div
              id="slider"
              class="carousel slide carousel-fade carousel-dark mt-5"
            ...
            >
              ...
              {/*the end of div  carousel-indicators*/}
                ...
                >
                  <div className="card rounded-4 text-start p-4 card-field w-50">
                    <div className="card-icon primary-text  d-flex justify-content-center align-items-center">
                      ...
                      >
                        <path
                          d="M16 2v0.8c0 2.7 0.9 5.3 2.6 7.4c-0.5 2.6-1.9 4.9-4.1 6.4c-1.5 0.8-3.2 1.1-5 0.9l-1.2-0.1c-1.4-0.3-2.8 0.1-3.8 1.1C3.5 19.5 3 20.7 3 21.9V29"
                          fill="none"
                          stroke="currentColor"
                          stroke-width="1.824"
                        ...
                        />
                        <path
                          d="M20 2v0.4C20 7 22 9 22 9h0.9c3.4 0 6.1 2.7 6.1 6.1c0 1.9-0.5 3.8-1.4 5.5c-2.2 3.9-6.6 6.4-11.9 5.8c-2.4-0.2-4.7-1.1-6.5-2.6C8.3 23 7 23.6 7 24.7V29"
                          fill="none"
                          stroke="currentColor"
                          stroke-width="1.824"
                          stroke-linecap="round"
                    ...
                    <div className="card-body text">
                      ...
                      <div className="card-text">
                        <p>
                          Our doctors are specialized in Internal Medicine with
                          wide experience and continuous follow-up.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="carousel-item d-flex justify-content-center align-items-center">
                  <div className="card rounded-4 text-start p-4 card-field w-50">
                    ...
                    <div className="card-body text">
                      ...
                      <div className="card-text">
                        <p>
                          Our doctors are specialized in Eye Department with
                          wide experience and continuous follow-up.
                        </p>
                      </div>
                    </div>
                ...
                <div class="carousel-item d-flex justify-content-center align-items-center">
                  <div className="card rounded-4 text-start p-4 card-field w-50">
                    ...
                    <div className="card-body text">
                      ...
                      <div className="card-text">
                        <p>
                          Our doctors are specialized in Dental Department with
                          wide experience and continuous follow-up.
                        </p>
                      </div>
                    </div>
